 ...
 *
 */
public class MK_4 extends SimState	{
    ...
    public void start() {
        ...
        try {
            ...
            URL flood3File = MK_4.class.getResource
            		("/data/NorfolkFZ3.shp");
            ...
            URL flood2File = MK_4.class.getResource
            		("/data/NorfolkFZ2.shp");
    ...
    public void populateAgent(String filename)	{
        ...
        try	{
            String filePath = MK_4.class.getResource(filename).getPath();
