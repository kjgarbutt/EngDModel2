 ...
 *
 */
public class MK_4WithUI extends GUIState	{
     ...
     * Default constructor
     */
    protected MK_4WithUI(SimState state)	{
            super(state);
        }
        ...
        public static void main(String[] args)	{
        	MK_4WithUI simple = new MK_4WithUI(
        			new MK_4(System.currentTimeMillis()));
        ...
        public void init(Controller c)
        {
            ...
            displayFrame.setTitle("EngD ABM Model MK_2");
