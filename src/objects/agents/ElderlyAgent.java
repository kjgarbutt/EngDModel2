...
public final class ElderlyAgent implements Steppable	{
	 ...
	 */
    public ElderlyAgent(MK_4 g, String homeTract, String workTract,
    ...
    public ElderlyAgent(MK_4 g, int homeTract, int workTract,
			GeomPlanarGraphEdge startingEdge, GeomPlanarGraphEdge goalEdge) {
	}
   ...
   public void step(SimState state)	{
       ...
       boolean toWork2 = ((MK_4) state).goToWork2;
